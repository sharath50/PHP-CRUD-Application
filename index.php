...
<?php 
	...
	function insert_into_database() {
		global $empName , $empAge , $empGender , $empRole , $empSalary , $empAddress , $connection;

		$insert_query = "INSERT INTO employee_record(emp_name , emp_age , emp_role , salary , home_address , sex) VALUES('{$empName}' , '{$empAge}' , '{$empRole}' , '{$empSalary}' , '{$empAddress}', '{$empGender}');";
		...
		<div class="row">
			<div class="col-8">
				<form class="form-group" action="" method="POST">
					...
					<div class="form-group">
						<button class="btn btn-sm btn-outline-success btn-block d-inline-block" name="submit" type="submit">Create</button>
						<a class="btn btn-sm btn-outline-info d-inline-block" href="Read_database.php">Read</a>
						<a class="btn btn-sm btn-outline-primary d-inline-block" href="Update_database.php">Update</a>
